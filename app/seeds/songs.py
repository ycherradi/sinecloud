...
def seed_songs():
    ...
    popSong1 = Song(title='If I Were A Boy', description='pop', image_url="https://i1.sndcdn.com/artworks-000534241092-qya04p-t500x500.jpg", audio_file='https://sinecloud.s3.amazonaws.com/cb565906ee0c446e81063b7ce9f6ce3a.mp3', artist='Beyoncé', genre_id='2', user_id='1')
    ...
    popSong3 = Song(title='Despacito', description='pop', image_url='http://res.cloudinary.com/alick/image/upload/v1502689731/Despacito_uvolhp.jpg', audio_file='https://sinecloud.s3.amazonaws.com/aa5bcbdd4d9f4ed7b94adbd8b018609c.mp3', artist='Luis Fonsi', genre_id='2', user_id='1')
    ...
    popSong5 = Song(title='Hey Ya!', description='pop', image_url='https://sinecloud.s3.amazonaws.com/3a25a41ba4e540c6b307c04a800c2f8d.jpg', audio_file='https://sinecloud.s3.amazonaws.com/bea7774cd9fc4e8cb840749e5826b31a.mp3', artist='Outkast', genre_id='2', user_id='1')
